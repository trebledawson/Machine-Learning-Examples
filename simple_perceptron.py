...
class SimplePerceptron:
    ...
    def gradient_descent(self, class_data, nonclass_data, eta = 0.01):
...
##############################
#  User-generated data test  #
##############################

def user_generated_test():
    start = time.time()
    print('Program start.')
...
def iris_test():
    ...
    # Train perceptron classifier
    print('Training perceptron classifier...')
    sp = SimplePerceptron(data_train, target_train)

    # Classification of test data
    predictions = sp.predict(data_test)
